...
def main():
    ...
    temp_input = os.path.join(args.out_dir, "temp_spmf_in_gsp.txt")
    temp_output = os.path.join(args.out_dir, "temp_spmf_out_gsp.txt")
    ...
    cmd = ["java", "-jar", spmf_jar, "run", "GSP", temp_input, temp_output, str(min_sup_relative)]
